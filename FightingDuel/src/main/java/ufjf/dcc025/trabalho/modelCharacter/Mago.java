...
public class Mago extends ClassePersonagem{
    ...
    // Atributos ---------------------------------------------------------------
    float vidaMax;  // Vida máxima que um Personagem da classe Mago pode ter
    float forcaAtk; // Força de ataque de um Personagem da classe Mago
    float forcaDef; // Força de defesa de um Personagem da classe Mago
